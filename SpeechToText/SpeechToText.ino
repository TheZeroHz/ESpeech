...
#define SERVER_URL "http://192.168.0.100:8888/uploadAudio"  //change the IP Address according To Your Servers config
#define I2S_WS 16
#define I2S_SD 7
#define I2S_SCK 15
...
#define RECORD_TIME (5) // Your Desired Time In Seconds [note:If want to increase record time then change partiotion type]
